...
@MessageTag(value = "VOLV:GroupOp", flag = MessageTag.ISCOUNTED
		| MessageTag.ISPERSISTED)
public class GroupOperationMessage extends MessageContent {
	 ...
	 */
	public static final Creator<GroupOperationMessage> CREATOR = new Creator<GroupOperationMessage>() {

		@Override
		public GroupOperationMessage createFromParcel(Parcel source) {
			return new GroupOperationMessage(source);
		}

		@Override
		public GroupOperationMessage[] newArray(int size) {
			return new GroupOperationMessage[size];
		}
	};
	...
	public GroupOperationMessage(Parcel in) {
	...
	public static GroupOperationMessage obtain(String operatorUserId,
			String operation, String data, String message) {
		GroupOperationMessage obj = new GroupOperationMessage();
	...
	public GroupOperationMessage(byte[] data) {
		String jsonStr = null;
		try {
